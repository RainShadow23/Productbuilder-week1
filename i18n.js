...
const translations = {
    ko: {
        ...
        'calc.search.results': '🔍 검색 결과',
        'calc.search.no.results': '검색 결과가 없습니다',
        'calc.search.add.custom': '직접 추가하기',
        'calc.coin.popular': '🔥 인기 코인',
        'calc.coin.custom': '➕ 커스텀 코인',
        ...
        'msg.expected.avg': '예상 평단가:',
        'msg.target.too.high': '목표 평단가는 현재 평단가보다 낮아야 합니다.',
        'msg.target.below.calc': '목표 평단가는 계산 기준 가격보다 높아야 합니다.',
    ...
    en: {
        ...
        'calc.search.results': '🔍 Search Results',
        'calc.search.no.results': 'No results found',
        'calc.search.add.custom': 'Add manually',
        'calc.coin.popular': '🔥 Popular Coins',
        'calc.coin.custom': '➕ Custom Coins',
        ...
        'msg.expected.avg': 'Expected Avg:',
        'msg.target.too.high': 'Target average must be lower than current average.',
        'msg.target.below.calc': 'Target average must be higher than calculation price.',
